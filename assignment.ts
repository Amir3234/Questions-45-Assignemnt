...
let personal_name:string="Amir Hussain";
...
Print your message. */
let famous_Qout:string='Franklin D. Roosevelt';
let message:string =' ${famous_Qout} said,"The only thing we have to fear is fear itself."'
...
let favorite_number:number=323436;
...
/* Q=11 Names: Store the names of a few of your friends in a array called names.
 ...
 let array:string[]=["Ahsan","Mohsin","Shahid","Ali"]
...
let array1:string[]=["Ahsan","Mohsin","Shahid","Ali"]
...
/* Q=13 Your Own Array: Think of your favorite mode of transportation, such as a motorcycle
 ...
 let favoriteTransportation:string[]=["Yamaha YBR","Honda 125","Honda Civic","Toyota Grande"]
...
let guestList:string[]=["Ali","Ahsan","Mohsin","kumail"]
...
let guestList1:string[]=["Ali","Ahsan","Mohsin","kumail"]
console.log(guestList1)
let PersonNotComing:string[]=["Mohsin"]
...
let guestList2:string[]=["Ali","Ahsan","Mohsin","kumail"]
...
guestList2.forEach((invitation)=>(
    console.log(`Mr.${invitation} I am very happy to invite on my dinner`)
))
...
let guestsWhole1: string[] = ["Ali","Ahsan","Mohsin","kumail"]
console.log("Sorry, I can only invite two people for dinner.");
while (guestsWhole1.length > 2) {
  let removedGuest: string | undefined = guestsWhole1.pop();
...
let favoriteLocation:string[]=["America","United Kingdom","Pakistan","Canada","India"]
...
/* Q=19 Dinner Guests: Working with one of the programs from Exercises 14 through 18, print a message indicating
 ...
 let guestList3:string[]=["Ali","Ahsan","Mohsin","kumail"]
...
let languages:string[]=["Urdu","English", "Sindhi","Punjabi"]
...
console.log(identification)
 ...
 /* Q=22 Intentional Error: If you haven’t received an array index error in one of your programs yet,
  try to make one happen. Change an index in one of your programsto produce an index error. Make sure you
   ...
   let intentionError:string[]=["Ali","Ahsan","Mohsin","Bilal","Kumail"]
...
let current_user:string[]=["Ali","Ahsan","Mohsin","Kumail","Bilal"]
let new_user:string[]=["Ali","Ahsan","Nouman","Kumail","Bilal"]
...
let favoritePizzas: string[] = ["Chicken Tikka", "Chicken Supreme", "Crown Crust"];
...
function make_Album(artist: string, albumTitle: string, tracks?: number): Record<string, any> {
...
function magician(magician_show:string[]=["Ali","Ahsan","Amir","Bilal"]) {
...
stored correctly */
function createCar(manufacturer: string, model: string, options: { [key: string]: any }): Record<string, any> {
  ...
  console.log("PIAIC Roll # PIAIC215173")
  console.log("Email: amirmalik323436@gmail.com")
